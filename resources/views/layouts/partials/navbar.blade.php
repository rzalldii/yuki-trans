        ...
        <div class="navbar-nav align-items-center">
            ...
            @else
                <a href="{{ route('dashboard') }}" class="d-flex align-items-center gap-2 text-decoration-none">
                    ...
                    <span class="fw-bold text-uppercase text-body" style="font-size: 1.1rem; letter-spacing: 0.5px;">
                        {{ config('app.name') }}
                    </span>
                </a>
            @endauth
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            @auth
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow p-0 cursor-pointer" href="javascript:void(0);" data-bs-toggle="dropdown" aria-label="User profile" style="cursor: pointer;">
                        <div class="avatar avatar-online cursor-pointer" style="cursor: pointer;">
